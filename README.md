...
2. Paste the latest release URL:
   ```
   https://github.com/samhenshaw-bit/SteamLEDPersonal/releases/download/V1/SteamLED.zip
   ```
   For future releases, replace `V1` with the tag name, or use the always-current redirect:
   ```
